...
auto_analysis_function <- function(i){
     datafile_single <- datafile_analysis %>% 
          filter(disease_1 == datafile_class_A$disease_list[i]) %>% 
          ...
          complete(
               ...
               fill = list(value = 0,
                           disease_1 = datafile_class_A$disease_list[i])
          )
     ...
     if (datafile_class_A$Method[i] == 'SARIMA'){
     ...
     if (datafile_class_A$Method[i] == 'STL'){
     ...
     if (datafile_class_A$Method[i] == 'ETS'){
     ...
     if (datafile_class_A$Method[i] == 'Neural Network'){
     ...
     if (datafile_class_A$Method[i] == 'Grey Model'){
     ...
     if (datafile_class_A$Method[i] == 'Hybrid'){
     ...
     if (datafile_class_B$Method[i] == 'SARIMA'){
     ...
     if (datafile_class_B$Method[i] == 'STL'){
     ...
     if (datafile_class_B$Method[i] == 'ETS'){
     ...
     if (datafile_class_B$Method[i] == 'Neural Network'){
     ...
     if (datafile_class_B$Method[i] == 'Grey Model'){
     ...
     if (datafile_class_B$Method[i] == 'Hybrid'){
     ...
     write.xlsx(cbind(outcome_plot_2, outcome_plot_3),
                paste0('./outcome/simulate data/B_', datafile_class_A$disease_name[i], '.xlsx'))
     ...
     fig1 <- ggplot()+
          ...
          labs(x = ifelse(i>20, "Date", ''),
               ...
               color = '',
               title = paste0(LETTERS[i], ': ', datafile_class_A$disease_name[i]))
